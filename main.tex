...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{Figures/rdiscont.png}
...
\begin{align}
    \text{to: }\dot{\theta}^2 = -\frac{g}{r}\cos{\theta} + \frac{3}{2}\dot{\theta}^2 - \frac{1}{2}a^{4n}\sigma^2 + \frac{g}{r}
\end{align}
Which simplifies to:
...
\begin{itemize}
    \item Ben Crossland - Section for a recursive solution, modelling.
    \item Chin Phin Ong (Linus) - Introduction and literary research, section on swings, plot, proofreading
    \item Gabriella Iuliano - abstract, on swings, conclusion
    \item Jacob Smith - Model, Solved some equations.
